import './log.js'
import {app, BrowserWindow, Menu, MenuItem, Tray, screen as electronScreen, shell, dialog} from 'electron'
...
const realUserAgent = `plebones/${packageJson.version}`
...
const createMainWindow = () => {
  ...
  // do not open links in plebones or will lead to remote execution
